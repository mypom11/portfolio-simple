    ...
    <ul className="px-14 flex-col flex gap-12 md:px-4">
      <li>
        ...
        <p className="mb-8 md:text-sm md:mb-4">
          ...
          웹사이트를 기획, 포토샵과 XD를 활용하여 디자인하는 방법을 배웠습니다.
          HTML,CSS,JaScript,Jqurey의 기본과 반응형 웹사이트 및 기본 웹사이트
          제작 하는 방법을 배웠습니다. 추가적으로 nodeJs와 socket.io를 사용하여
          채팅사이트 제작, php를 이용한 게시판 제작 등을 배웠으며 많은
          사이트들을 클론코딩 해보며 코딩의 기본을 다졌습니다.
        </p>
        <hr />
      </li>
      <li>
        <div className="flex justify-between items-center mb-2">
          <h1 className="text-2xl font-bold md:text-lg">신세계 컴퓨터 학원</h1>
        </div>
        <p className="italic mb-2 md:text-sm">
          2020.12 ~ 2021.02
