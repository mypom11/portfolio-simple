      ...
      <ul className="px-14 flex-col flex gap-12">
        <li>
          ...
          <p className="mb-8">
            ...
            <br /> GridStack라이브러리를 활용하여 대시보드를 사용자가 직접
            커스텀 할 수 있는 컴포넌트를 제작하였습니다.
        ...
        <li>
          ...
          <p>
            ...
            참여하였습니다.
            <br /> 프론트엔드는 저 혼자였기에 3명의 백엔드와 같은 기간에
            여러개의 프로젝트를 동시 진행하였습니다.
            <br /> 다양한 프로젝트를 접하며 클린 코딩까지는 못하지만 구현능력이
            크게 올랐으며 프로젝트 진행을 위해 혼자서 Vuejs를 공부하며
            프로젝트를 진행한 덕분에 혼자서 빠르게 언어를 습득하는 방법을
            익혔습니다.
          </p>
        </li>
      </ul>
